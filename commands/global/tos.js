...
module.exports = {
  ...
  run: async (bot, message, args) => {
    try {
      ...
      .setFooter("Thank you for understanding. Have a question? Contact my developer: ex-exoad#9292")
